  ...
  return (
    <>
      ...
      <form
        ...
        className="px-8 py-4 mb-4 w-11/12 sm:w-8/12 md:w-6/12 lg:w-5/12 xl:w-4/12 flex flex-col fixed top-2/4 left-2/4 -translate-x-1/2 -translate-y-1/2 bg-slate-200 border-2 border-slate-400"
      >
        <IoCloseSharp
